...
def test_execution_admissibility_model():
    ...
    assert admissibility.execution_id == "exec-001"
    assert admissibility.envelope == envelope
    assert admissibility.context_integrity == context_integrity
    assert admissibility.refusal == refusal
    assert (
...
def test_execution_admissibility_is_frozen():
    ...
    with pytest.raises(FrozenInstanceError):
        admissibility.execution_id = "changed"